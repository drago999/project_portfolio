# -*- coding: utf-8 -*-
"""
Created on Wed Apr 24 18:29:05 2024
...
def negate_denom(data_frame):
    #denominator = ['salarie/employee', 'advertisingCosts/advanceBooking']
...
def clear_denom(data_frame):
    ...
    for x in site_data:
        ...
        if(x != 'revenue' and x != 'rentals/complaint' and x != 'cars/cost'):
